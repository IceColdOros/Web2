...
<head>
    ...
    <link rel="stylesheet" href="../Style/carCat.css">
...
<body>
    ...
    <section id="product1" class="section-p1">
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="../Products/catCar.jpeg" alt="">
                <div class="des">
                    <span>Car</span>
                    <h5>Car Mats</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="../Products/catCar1.jpg" alt="">
                <div class="des">
                    <span>Car</span>
                    <h5>Car Scrub</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="../Products/catCar2.jpg" alt="">
                <div class="des">
                    <span>Car</span>
                    <h5>Steering Wheel Cover</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                <img src="../Products/catCar4.jpg" alt="">
                <div class="des">
                    <span>Car</span>
                    <h5>Car Shifter</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="../Products/catCar5.jpg" alt="">
                <div class="des">
                    <span>Car</span>
                    <h5>Front Lip</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="../Products/catCar6.jpg" alt="">
                <div class="des">
                    <span>Car</span>
                    <h5>Rear Wing</h5>
                    <div class="star">
