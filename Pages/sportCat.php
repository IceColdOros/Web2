...
<head>
    ...
    <link rel="stylesheet" href="../Style/sportCat.css">
...
<body>
    ...
    <section id="sport-header">
        <h2>#Sport</h4>
        <p>Perform like none other</p>
    </section>
    ...
    <section id="product1" class="section-p1">
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="../Products/catSport.webp" alt="">
                <div class="des">
                    <span>Sport</span>
                    <h5>Tennis Racket</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="../Products/catSport1.webp" alt="">
                <div class="des">
                    <span>Sport</span>
                    <h5>Tennis Racket</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="../Products/catSport2.webp" alt="">
                <div class="des">
                    <span>Sport</span>
                    <h5>Padel Racket</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="../Products/catSport3.avif" alt="">
                <div class="des">
                    <span>Sport</span>
                    <h5>Padel Racket</h5>
                    <div class="star">
            ...
            <div class="pro">
                <img src="../Products/sport3.jpg" alt="">
                <div class="des">
                    <span>Sport</span>
                    <h5>Rugby Ball</h5>
                    <div class="star">
